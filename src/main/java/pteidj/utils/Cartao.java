           ...
           /* // Read Certificates
            ...
            System.out.println("Number of certs found: " + certs.length);
               ...
               // cert_byte = auth08.certif;
                ...
                FileInputStream is = new FileInputStream (new File("C:\\Users\\Andre\\Documents\\certificados\\EC de Autenticacao do pteidj.utils.Cartao de Cidadao 0008.pem"));
               ...
               // cert_byte = cartao02.certif;
                certFactory = CertificateFactory.getInstance("X.509");
                is = new FileInputStream (new File("C:\\Users\\Andre\\Documents\\certificados\\pteidj.utils.Cartao de Cidadao 002.pem"));
